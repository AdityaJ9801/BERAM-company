...
def main():
    ...
    print("You can share this entire folder with anyone, and they can view the website by opening index.html")
    print("For Windows users, they can also double-click on Open_BeRAM_Website.bat")
